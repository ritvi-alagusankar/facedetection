...
train_data_save_path = "lbph_train_data_augmented" # Augmented CROPPED faces for training
validation_data_save_path = "lbph_validation_data_original_images" # ORIGINAL FULL images for validation
...
if __name__ == "__main__":
    ...
    print(" (Save Original Test Images, Augment Train Faces)")
    print("="*40)
